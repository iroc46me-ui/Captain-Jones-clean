...
export default function BuyerHarborConversationPage() {
  ...
  return (
    <main className="min-h-screen bg-[#071116] text-stone-100">
      <section className="border-b border-cyan-300/20 bg-gradient-to-r from-[#071116] via-[#10242c] to-[#071116]">
        <div className="mx-auto max-w-4xl px-6 py-8 sm:px-10 lg:px-16">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-cyan-300">
            Captain&apos;s Locker · Harbor Conversation
          </p>
          ...
          <p className="mt-3 text-stone-300">
            Conversation with {inquiry.seller}
          </p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-8 sm:px-10 lg:px-16">
        ...
        <div className="mt-8 rounded-3xl border border-cyan-300/20 bg-white/[0.04] p-6">
          ...
          <button
            ...
            className="mt-4 rounded-full bg-cyan-300 px-6 py-3 font-bold text-slate-950 disabled:cursor-not-allowed disabled:opacity-60"
          >
